...
const experiences: Experience[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        company: 'Mecha',
        description:
          'As a Software & Systems Developer at Mecha, I upgraded IT systems to MS365, including SharePoint for file management and Exchange for email. Collaborating with stakeholders, I integrated MS Power Apps, Forms, and Lists to automate work processes, significantly enhancing safety, efficiency, and overall organizational productivity.',
      },
      {
        startDate: 'Jun 2016',
        endDate: 'May 2021',
        ...
        company: 'Woolworths',
        description:
          'At Woolworths, I gained five years of experience in customer service, team collaboration, and time management, enhancing my communication skills and ability to work under pressure.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "I am currently volunteering as a Young Tech Ambassador with the ACS YTA Program, funded by Queensland's Digital Professional Workforce Action Plan. I'm helping high school students get excited about tech careers while boosting my own leadership and communication skills.",
      },
      {
        startDate: 'Jan 2024',
        endDate: 'Present',
        duration: 'Currently',
        role: 'Emerging Professional Committee Member',
        company: 'Australian Computer Society',
        description:
      ...
      },
      {
        ...
        company: 'QUT BAMSA',
        description:
          'The president represents BAMSA as the spokesperson, sets the strategic direction of the club, prioritises goals and oversees the delivery of outcomes, presides and leads during club meetings and preserves order, acting as the club\'s leader and ambassador to represent team members.',
      },
      {
        startDate: 'Sep 2021',
        endDate: 'Sep 2022',
        ...
        company: 'QUT BAMSA',
        description:
          'The corporate events director is a managerial role that takes charge of designing, planning, and communicating with venues for all corporate events throughout the year.',
      },
    ],
  },
];
