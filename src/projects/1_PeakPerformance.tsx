  ...
  return (
    <Box
      sx={{
        width: { xs: '80%', md: '50%' },
        margin: 'auto',
        textAlign: { xs: 'align-left', md: 'justify' },
        mb: '100px',
      }}
    >
      ...
      <Grid container sx={{ display: 'flex', alignItems: 'center' }}>
        <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'center' }}>
          <img height="600px" src="/peakPerformance/1T.gif" alt="Peak Performance App Feature 1" />
        </Grid>
        ...
        <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'center' }}>
          <img height="600px" src="/peakPerformance/3T.gif" alt="Peak Performance App Feature 3" />
        </Grid>
        <Grid item xs={12} md={6} sx={{ display: { xs: 'none', md: 'flex' }, justifyContent: 'center' }}>
          <img height="600px" src="/peakPerformance/4T.gif" alt="Peak Performance App Feature 4" />
        </Grid>
        <Grid item xs={12} md={6}>
        ...
        <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'center' }}>
          <img height="600px" src="/peakPerformance/5T.gif" alt="Peak Performance App Feature 5" />
        </Grid>
        <Grid item xs={12} md={6} sx={{ display: { xs: 'none', md: 'flex' }, justifyContent: 'center' }}>
          <img height="600px" src="/peakPerformance/6T.gif" alt="Peak Performance App Feature 6" />
        </Grid>
        <Grid item xs={12} md={6}>
